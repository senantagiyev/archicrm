 ...
 *   date · image_select · image_multiselect · matrix · color_swatch ·
 *   budget_range · room_inventory · consent · file
 *
 * ── Şəklin iki rolu (Roomix analizindən, docs/roomix-brief-ux-analiz.md) ──
 *
 * A patterni — SEÇİMİN ÖZÜ ŞƏKİLDİR: `image_select` / `image_multiselect`.
 *   Variantlar foto kart şəbəkəsi kimi render olunur. Yalnız üslub kimi
 *   «gözlə seçilən» suallar üçün. Şəkil yoxdursa kart neytral placeholder
 *   kimi görünür — quruluş yenə də doğrudur.
 *
 * B patterni — SEÇİM MƏTNDİR, ŞƏKİL İLHAM NÜMUNƏSİDİR: sualda `'inspire' => true`.
 *   Variant adi sətir kimi qalır, sağında kiçik ikon variantın nümunə
 *   fotolarını modalda açır. 60+ variantlı material/işıq siyahılarını foto
 *   kartlara çevirmədən vizual edən yol budur.
 *
 * Şəkil yolları variantın içində saxlanılır (`image_url` / `images`) və admin
 * panelindən yüklənir — bankda hardcode EDİLMİR.
 */
...
return [
    ...
    [
        ...
        'estimated_minutes' => 3,
        'questions' => [
            ['key' => 'household_members', 'group' => 'Ailə və məişət', 'label' => 'Ailə tərkibi — kim, neçə yaşında, hansı xüsusiyyətlərlə', 'type' => 'textarea', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Bu, hər kəs üçün erqonomikanı nəzərə almağa kömək edəcək (ad, yaş, boy, əl üstünlüyü).'],
            ['key' => 'adults_count', 'group' => 'Ailə və məişət', 'label' => 'Evdə neçə böyük yaşayır?', 'type' => 'number', 'options' => null, 'required' => false, 'delegatable' => false],
            ['key' => 'hobbies_profession', 'group' => 'Ailə və məişət', 'label' => 'Maraqlar / peşə və evdə nə nəzərə alınmalıdır', 'type' => 'textarea', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Hobbi zonalaşdırmanın hissəsinə çevrilə bilər.'],
            ['key' => 'frequent_guests', 'group' => 'Ailə və məişət', 'label' => 'Tez-tez qonaq qəbul edirsiniz?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => false],
            ['key' => 'future_plans_5_10y', 'group' => 'Ailə və məişət', 'label' => '5–10 illik planlarınız', 'type' => 'textarea', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Məsələn: uşaq doğulması, uzaqdan iş, valideynlərin köçməsi.'],
            ['key' => 'has_pets', 'group' => 'Heyvanlar və sağlamlıq', 'label' => 'Ev heyvanlarınız var?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => false],
            ['key' => 'pet_type', 'group' => 'Heyvanlar və sağlamlıq', 'label' => 'Heyvanın tipi', 'type' => 'multiselect',
            ...
            ['key' => 'pet_zone_needs', 'group' => 'Heyvanlar və sağlamlıq', 'label' => 'Heyvanlar üzrə xüsusi tələblər', 'type' => 'textarea', 'options' => null, 'required' => false, 'delegatable' => true,
                'help' => 'Yataq, caynaq itiləyən, WC, məhdudlaşdırıcılar.',
                'skip' => ['question' => 'has_pets', 'operator' => 'equals', 'value' => '1']],
            ['key' => 'has_allergies', 'group' => 'Heyvanlar və sağlamlıq', 'label' => 'Ailədə allergiya var?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => false],
            ['key' => 'allergy_details', 'group' => 'Heyvanlar və sağlamlıq', 'label' => 'Allergiya detalları', 'type' => 'textarea', 'options' => null, 'required' => false, 'delegatable' => false,
            ...
            ['key' => 'works_from_home', 'group' => 'İş və vərdişlər', 'label' => 'Evdən işləyirsiniz?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Bəli olduqda otaqlar bölməsində kabinet əlavə etməyi unutmayın.'],
            ['key' => 'smoking_indoors', 'group' => 'İş və vərdişlər', 'label' => 'Evdə siqaret çəkilirmi?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => false],
            ['key' => 'decision_maker', 'group' => 'Qərar və tanışlıq', 'label' => 'Dizayn üzrə yekun qərarları kim qəbul edir?', 'type' => 'select',
            ...
            ['key' => 'lead_source', 'group' => 'Qərar və tanışlıq', 'label' => 'Bizi haradan öyrəndiniz?', 'type' => 'multiselect',
                'options' => $opt(['instagram' => 'Instagram', 'facebook' => 'Facebook', 'ads' => 'Reklam', 'friends' => 'Tanışlardan', 'word_of_mouth' => 'Ağızdan-ağıza', 'other' => 'Digər']),
                'required' => false, 'delegatable' => false],
            ['key' => 'why_chose_us', 'group' => 'Qərar və tanışlıq', 'label' => 'Niyə məhz bizi seçdiniz?', 'type' => 'textarea', 'options' => null, 'required' => false, 'delegatable' => false],
        ],
    ],
    ...
    [
        ...
        'estimated_minutes' => 5,
        'questions' => [
            ['key' => 'object_address', 'group' => 'Ünvan və sahə', 'label' => 'Obyektin ünvanı', 'type' => 'text', 'options' => null, 'required' => true, 'delegatable' => false],
            ['key' => 'object_location_note', 'group' => 'Ünvan və sahə', 'label' => 'Yerləşmə', 'type' => 'text', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Məsələn: rayon, yaşayış kompleksi, oriyentir.'],
            ['key' => 'object_type', 'group' => 'Ünvan və sahə', 'label' => 'Obyektin tipi', 'type' => 'select',
                'options' => $opt(['apartment' => 'Mənzil', 'house' => 'Fərdi ev']),
                'required' => true, 'delegatable' => false],
            ['key' => 'floor_info', 'group' => 'Ünvan və sahə', 'label' => 'Mərtəbə / mərtəbəlik', 'type' => 'text', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Məsələn: 12-dən 5.',
                'skip' => ['question' => 'object_type', 'operator' => 'equals', 'value' => 'apartment']],
            ['key' => 'house_floors_count', 'group' => 'Ünvan və sahə', 'label' => 'Evin mərtəbə sayı', 'type' => 'number', 'options' => null, 'required' => false, 'delegatable' => false,
                'skip' => ['question' => 'object_type', 'operator' => 'equals', 'value' => 'house']],
            ['key' => 'total_area_sqm', 'group' => 'Ünvan və sahə', 'label' => 'Ümumi sahə, m²', 'type' => 'number', 'options' => null, 'required' => true, 'delegatable' => false],
            ['key' => 'design_area_sqm', 'group' => 'Ünvan və sahə', 'label' => 'Dizayn-layihə üçün sahə, m²', 'type' => 'number', 'options' => null, 'required' => true, 'delegatable' => false,
                'help' => 'Bütün obyekti deyil, yalnız bir hissəsini rəsmiləşdirirsinizsə, buraya həmin sahəni yazın.'],
            ['key' => 'property_readiness', 'group' => 'Hazırlıq və ölçmə', 'label' => 'Obyektin hazırlığı', 'type' => 'select',
                'options' => $opt([
            ...
            ['key' => 'measurement_plan_file', 'group' => 'Hazırlıq və ölçmə', 'label' => 'Obmer planı faylı', 'type' => 'file', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'PDF, JPG və ya PNG.',
                'skip' => ['question' => 'has_measurement_plan', 'operator' => 'equals', 'value' => 'yes']],
            ['key' => 'building_year', 'group' => 'Hazırlıq və ölçmə', 'label' => 'Tikinti ili', 'type' => 'number', 'options' => null, 'required' => false, 'delegatable' => false],
            ['key' => 'ceiling_height_raw_mm', 'group' => 'Konstruksiya', 'label' => 'Tavan hündürlüyü (çılpaq), mm', 'type' => 'number', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Bilmirsinizsə, keçin — obmerdə dəqiqləşdirəcəyik.'],
            ['key' => 'screed_thickness_mm', 'group' => 'Konstruksiya', 'label' => 'Stəjka qalınlığı, mm', 'type' => 'number', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Bilmirsinizsə, keçin — obmerdə dəqiqləşdirəcəyik.'],
            ['key' => 'bearing_walls_material', 'group' => 'Konstruksiya', 'label' => 'Daşıyıcı divarların materialı və qalınlığı', 'type' => 'text', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Məsələn: monolit, 200 mm.'],
            ['key' => 'floor_slabs_system', 'group' => 'Konstruksiya', 'label' => 'Örtük sistemi və qalınlığı', 'type' => 'text', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Məsələn: monolit, 200 mm.'],
            ['key' => 'utilities_available', 'group' => 'Konstruksiya', 'label' => 'Obyektin mühəndislik şəbəkələri', 'type' => 'multiselect',
                'options' => $opt([
                    'gas' => 'Qazlaşdırma', 'city_sewer' => 'Şəhər kanalizasiyası',
                    'private_sewer' => 'Fərdi kanalizasiya', 'water' => 'Su təchizatı',
                ]),
                'required' => true, 'delegatable' => false],
            ['key' => 'premises_purpose', 'group' => 'Konstruksiya', 'label' => 'Mənzilin təyinatı', 'type' => 'select',
                'options' => $opt([
                    'permanent' => 'Daimi yaşayış', 'seasonal' => 'Mövsümi yaşayış (bağ evi)',
                    'commercial' => 'Kommersiya', 'mixed' => 'Qarışıq',
                ]),
                'required' => true, 'delegatable' => false],
            ['key' => 'windows_change', 'group' => 'Pəncərələr', 'label' => 'Pəncərələr dəyişdiriləcək?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => true],
            ['key' => 'windowsills_change', 'group' => 'Pəncərələr', 'label' => 'Pəncərə lövhələri dəyişdiriləcək?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => true],
            ['key' => 'freight_elevator', 'group' => 'Çatdırılma və giriş', 'label' => 'Yük lifti var?', 'type' => 'select',
                'options' => $opt(['yes' => 'Bəli', 'no' => 'Xeyr', 'unknown' => 'Bilmirəm']),
                'required' => false, 'delegatable' => false,
                'skip' => ['question' => 'object_type', 'operator' => 'equals', 'value' => 'apartment']],
            ['key' => 'staircase_width', 'group' => 'Çatdırılma və giriş', 'label' => 'Pilləkən meydançasının eni', 'type' => 'text', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Məsələn: 1,2 m.',
                'skip' => ['question' => 'object_type', 'operator' => 'equals', 'value' => 'apartment']],
            ['key' => 'large_materials_turn', 'group' => 'Çatdırılma və giriş', 'label' => 'İrigabaritli materialları döndərmək mümkündür?', 'type' => 'select',
                'options' => $opt(['yes' => 'Bəli', 'no' => 'Xeyr', 'unknown' => 'Bilmirəm']),
                'required' => false, 'delegatable' => false],
            ['key' => 'materials_delivery_comment', 'group' => 'Çatdırılma və giriş', 'label' => 'Materialların qaldırılması üzrə şərh', 'type' => 'textarea', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Mərtəbə, lift, dar keçidlər, məhdudiyyətlər.'],
            ['key' => 'furniture_heights', 'group' => 'Çatdırılma və giriş', 'label' => 'Mebel hündürlükləri — standartdan fərqli istəkləriniz', 'type' => 'textarea', 'options' => null, 'required' => false, 'delegatable' => true,
    ...
    [
        ...
        'estimated_minutes' => 2,
        'questions' => [
            ['key' => 'cooperation_scope', 'group' => 'Format', 'label' => 'Əməkdaşlıq formatı', 'type' => 'select',
                'options' => $opt([
                ...
                'required' => true, 'delegatable' => false],
            ['key' => 'project_budget_range', 'group' => 'Büdcə', 'label' => 'Layihənin büdcəsi', 'type' => 'budget_range', 'options' => null, 'required' => true, 'delegatable' => false,
                'help' => 'Təxmini diapazon kifayətdir — bu, sizin büdcənizdə real həllər təklif etməyə kömək edir.'],
            ['key' => 'budget_includes', 'group' => 'Büdcə', 'label' => 'Büdcə nələri əhatə edir?', 'type' => 'multiselect',
                'options' => $opt([
                    'materials' => 'Materiallar', 'furniture' => 'Mebel', 'appliances' => 'Texnika',
                    'design_fee' => 'Dizaynerin işi', 'construction' => 'Təmir işləri',
                ]),
                'required' => false, 'delegatable' => false],
            ['key' => 'desired_start_date', 'group' => 'Vaxt', 'label' => 'İstənilən başlama tarixi', 'type' => 'date', 'options' => null, 'required' => false, 'delegatable' => false],
            ['key' => 'desired_completion_date', 'group' => 'Vaxt', 'label' => 'İstənilən bitmə / köçmə tarixi', 'type' => 'date', 'options' => null, 'required' => false, 'delegatable' => false],
            ['key' => 'timeline_flexibility', 'group' => 'Vaxt', 'label' => 'Müddətlərin çevikliyi', 'type' => 'select',
    ...
    [
        ...
        'questions' => [
            ['key' => 'unified_style', 'label' => 'Bütün evdə vahid üslub olsun?', 'type' => 'select',
                ...
                'required' => false, 'delegatable' => true],
            // A patterni: üslub gözlə seçilir, ona görə foto kart şəbəkəsi.
            ['key' => 'style_preferences', 'label' => 'Sizə yaxın olan üslublar', 'type' => 'image_multiselect',
                'group' => 'Üslub',
                'options' => $opt([
                ...
                'required' => false, 'delegatable' => true,
                'help' => 'Bir neçəsini seçə bilərsiniz — dizayner onlardan vahid obraz yığacaq.'],
            ['key' => 'custom_style_reference', 'label' => 'Öz referanslarınız (link və ya təsvir)', 'type' => 'textarea', 'group' => 'Üslub', 'options' => null, 'required' => false, 'delegatable' => false],
            // Part 9.4: file_upload / url — the upload half of the pair.
            ['key' => 'custom_style_reference_file', 'label' => 'Referans foto yükləyin', 'type' => 'file', 'group' => 'Üslub', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'PDF, JPG və ya PNG.'],
            ['key' => 'open_to_unconventional', 'label' => 'Qeyri-standart həllərə hazırsınız?', 'type' => 'select',
                'group' => 'Konsepsiya və istəklər',
                'options' => $opt(['yes' => 'Bəli', 'no' => 'Xeyr', 'designer' => 'Dizaynerin ixtiyarına']),
                'required' => false, 'delegatable' => true],
            ['key' => 'concept_base', 'label' => 'Konseptual əsas', 'type' => 'textarea', 'group' => 'Konsepsiya və istəklər', 'options' => null, 'required' => false, 'delegatable' => true,
                'help' => 'Məsələn: «isti Skandinav evinin atmosferi».'],
            ['key' => 'style_extra_notes', 'label' => 'Üslub üzrə əlavə istəklər', 'type' => 'textarea', 'group' => 'Konsepsiya və istəklər', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Nə nəzərə alınmalı, nədən qaçınmalı.'],
            ['key' => 'favorite_item_keep', 'label' => 'Yeni interyerə köçürüləcək sevimli əşya', 'type' => 'textarea', 'group' => 'Konsepsiya və istəklər', 'options' => null, 'required' => false, 'delegatable' => false],
            // Part 9.4: text + file_upload — the photo half of the pair.
            ['key' => 'favorite_item_photo', 'label' => 'Sevimli əşyanın fotosu', 'type' => 'file', 'group' => 'Konsepsiya və istəklər', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'JPG, PNG və ya PDF.'],
            ['key' => 'color_palette_visual', 'group' => 'Rəng', 'label' => 'Rəng palitrası', 'type' => 'color_swatch',
                'options' => [
                    'base_max' => 4,
                    'accent_max' => 2,
                    'swatches' => [
            ...
            ['key' => 'color_notes_freeform', 'group' => 'Rəng', 'label' => 'Öz sözlərinizlə rəng istəkləri', 'type' => 'textarea', 'options' => null, 'required' => false, 'delegatable' => false],
            ['key' => 'colors_to_avoid', 'group' => 'Rəng', 'label' => 'İstifadə edilməyəcək rənglər', 'type' => 'text', 'options' => null, 'required' => false, 'delegatable' => false],
            ['key' => 'interior_character', 'group' => 'Rəng', 'label' => 'İnteryerin xarakteri', 'type' => 'select',
                ...
                'required' => false, 'delegatable' => true],
            ['key' => 'color_temperature', 'group' => 'Rəng', 'label' => 'Tonların temperaturu', 'type' => 'select',
                'options' => $opt(['warm' => 'İsti', 'cold' => 'Soyuq', 'neutral' => 'Neytral', 'designer' => 'Dizaynerin ixtiyarına']),
                'required' => false, 'delegatable' => true],
            ['key' => 'metal_preferences', 'group' => 'Metallar', 'label' => 'Metallar', 'type' => 'multiselect',
                'options' => $opt([
                ...
                'required' => false, 'delegatable' => true],
            ['key' => 'surface_color_walls', 'group' => 'Səthlərin rəngi', 'label' => 'Divarların rəngi', 'type' => 'select',
                'options' => $opt(['light' => 'Açıq', 'dark' => 'Tünd', 'designer' => 'Dizaynerin ixtiyarına']),
                'required' => false, 'delegatable' => true],
            ['key' => 'surface_color_floor', 'group' => 'Səthlərin rəngi', 'label' => 'Döşəmənin rəngi', 'type' => 'select',
                'options' => $opt(['light' => 'Açıq', 'dark' => 'Tünd', 'designer' => 'Dizaynerin ixtiyarına']),
                'required' => false, 'delegatable' => true],
            ['key' => 'surface_color_ceiling', 'group' => 'Səthlərin rəngi', 'label' => 'Tavanın rəngi', 'type' => 'select',
                'options' => $opt(['light' => 'Açıq', 'dark' => 'Tünd', 'designer' => 'Dizaynerin ixtiyarına']),
                'required' => false, 'delegatable' => true],
        ],
    ],
    ...
    [
        ...
        'estimated_minutes' => 4,
        'questions' => [
            ['key' => 'finishes_full_override', 'group' => 'Materiallarda nə vacibdir', 'label' => 'Bu bölməni tamamilə dizaynerin ixtiyarına buraxıram', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Seçsəniz, bölmənin qalan sualları gizlədilir.'],
            ['key' => 'finishes_priorities', 'group' => 'Materiallarda nə vacibdir', 'label' => 'Materiallarda prioritetləriniz', 'type' => 'multiselect',
                'options' => $opt([
            ...
            ['key' => 'wall_materials', 'group' => 'Divarlar', 'inspire' => true, 'label' => 'Divar materialları', 'type' => 'multiselect',
                'options' => $opt([
                ...
                'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'finishes_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'wall_materials_comment', 'group' => 'Divarlar', 'label' => 'Divar materialları üzrə şərh (harada, hansı otaqda)', 'type' => 'textarea', 'options' => null, 'required' => false, 'delegatable' => false,
                'skip' => ['question' => 'wall_materials', 'operator' => 'filled', 'value' => null]],
            ['key' => 'skirting_type', 'group' => 'Divarlar', 'inspire' => true, 'label' => 'Plintus', 'type' => 'select',
                'options' => $opt([
                ...
                'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'finishes_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'floor_materials', 'group' => 'Döşəmə', 'inspire' => true, 'label' => 'Döşəmə materialları', 'type' => 'multiselect',
                'options' => $opt([
                ...
                'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'finishes_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'ceiling_materials', 'group' => 'Tavan', 'inspire' => true, 'label' => 'Tavan materialları', 'type' => 'multiselect',
                'options' => $opt([
                ...
                'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'finishes_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'multilevel_ceiling_ok', 'group' => 'Tavan', 'label' => 'Çoxsəviyyəli tavanlara münasibətiniz müsbətdir?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'finishes_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'door_height', 'group' => 'Qapılar', 'label' => 'Qapıların hündürlüyü', 'type' => 'select',
                ...
                'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'finishes_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'door_mounting', 'group' => 'Qapılar', 'label' => 'Qapıların montajı', 'type' => 'select',
                'options' => $opt(['standard' => 'Adi (nalişnikli)', 'hidden' => 'Gizli qutu', 'sliding' => 'Sürüşən', 'designer' => 'Dizaynerin ixtiyarına']),
                'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'finishes_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'door_material', 'group' => 'Qapılar', 'inspire' => true, 'label' => 'Qapıların materialı', 'type' => 'multiselect',
                'options' => $opt(['veneer' => 'Şpon', 'paint' => 'Boyalı', 'glass' => 'Şüşə', 'solid_wood' => 'Massiv', 'designer' => 'Dizaynerin ixtiyarına']),
                'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'finishes_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'door_locks_location', 'group' => 'Qapılar', 'label' => 'Kilidlər hansı qapılarda lazımdır?', 'type' => 'text', 'options' => null, 'required' => false, 'delegatable' => false,
                'skip' => ['question' => 'finishes_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'materials_to_avoid', 'group' => 'Nə olmamalıdır', 'label' => 'İstifadəsini istəmədiyiniz materiallar', 'type' => 'textarea', 'options' => null, 'required' => false, 'delegatable' => false,
                'skip' => ['question' => 'finishes_full_override', 'operator' => 'not_equals', 'value' => '1']],
        ],
    ],
    ...
    [
        ...
        'estimated_minutes' => 4,
        'questions' => [
            ['key' => 'lighting_full_override', 'group' => 'İşıqlandırma', 'label' => 'Bu bölməni tamamilə dizaynerin ixtiyarına buraxıram', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => false],
            ['key' => 'light_temperature', 'group' => 'İşıqlandırma', 'label' => 'İşığın rəng temperaturu', 'type' => 'select',
                'options' => $opt([
            ...
            ['key' => 'ceiling_lighting_types', 'group' => 'İşıqlandırma', 'inspire' => true, 'label' => 'Tavan işıqlandırması', 'type' => 'multiselect',
                'options' => $opt([
                ...
                'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'lighting_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'wall_lighting_types', 'group' => 'İşıqlandırma', 'inspire' => true, 'label' => 'Divar işıqlandırması', 'type' => 'multiselect',
                'options' => $opt(['bra' => 'Bra', 'wall_wash' => 'Divar işıqlandırması', 'picture_light' => 'Rəsm işıqları', 'designer' => 'Dizaynerin ixtiyarına']),
                'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'lighting_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'floor_lighting_types', 'group' => 'İşıqlandırma', 'inspire' => true, 'label' => 'Döşəmə / mobil işıqlandırma', 'type' => 'multiselect',
                'options' => $opt(['floor_lamp' => 'Torşer', 'table_lamp' => 'Stolüstü lampa', 'step_lights' => 'Pilləkən işıqları', 'designer' => 'Dizaynerin ixtiyarına']),
                'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'lighting_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'decorative_lighting_types', 'group' => 'İşıqlandırma', 'inspire' => true, 'label' => 'Dekorativ işıqlandırma', 'type' => 'multiselect',
                ...
                'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'lighting_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'dimmers_needed', 'group' => 'Dimmerlər', 'label' => 'Dimmerlər (işığın gücünün tənzimlənməsi) lazımdır?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'lighting_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'night_lighting_sensors', 'group' => 'Gecə işığı', 'label' => 'Gecə işıqlandırması (hərəkət sensorları) lazımdır?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'lighting_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'night_lighting_location', 'group' => 'Gecə işığı', 'label' => 'Gecə işıqlandırması harada?', 'type' => 'text', 'options' => null, 'required' => false, 'delegatable' => false,
                'skip' => ['question' => 'night_lighting_sensors', 'operator' => 'equals', 'value' => '1']],
            ['key' => 'curtains_type', 'group' => 'Pərdələr', 'inspire' => true, 'label' => 'Pərdələr', 'type' => 'select',
                'options' => $opt([
                ...
                'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'lighting_full_override', 'operator' => 'not_equals', 'value' => '1']],
            ['key' => 'curtains_blackout_location', 'group' => 'Pərdələr', 'label' => 'Tam qaranlıqlaşdırma hansı otaqlarda lazımdır?', 'type' => 'text', 'options' => null, 'required' => false, 'delegatable' => false,
    ...
    [
        ...
        'estimated_minutes' => 4,
        'questions' => [
            ['key' => 'replanning_needed', 'group' => 'Planlaşdırma', 'label' => 'Yenidənqurma (planlaşdırmanın dəyişdirilməsi) planlaşdırılır?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => true,
                'help' => 'Bəli olduqda istədiyiniz yeni planın eskizini «Obyekt» bölməsində fayl kimi əlavə edə bilərsiniz.'],
            ['key' => 'balcony_merge_with_room', 'group' => 'Planlaşdırma', 'label' => 'Balkon/loggiyanı otaqla birləşdirmək istəyirsiniz?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'room_inventory', 'operator' => 'has_room', 'value' => 'balcony']],
            ['key' => 'balcony_insulate', 'group' => 'Planlaşdırma', 'label' => 'Balkon/loggiya istiləşdiriləcək?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => true,
                'skip' => ['question' => 'room_inventory', 'operator' => 'has_room', 'value' => 'balcony']],
            ['key' => 'underfloor_heating', 'group' => 'İstilik', 'label' => 'İsti döşəmə', 'type' => 'select',
                ...
                'required' => false, 'delegatable' => true],
            ['key' => 'radiators_replace', 'group' => 'İstilik', 'label' => 'Radiatorlar / konvektorlar', 'type' => 'multiselect',
                ...
                'required' => false, 'delegatable' => true],
            ['key' => 'heating_control_type', 'group' => 'İstilik', 'label' => 'İstilik idarəetmə cihazının tipi', 'type' => 'select',
            ...
            ['key' => 'climate_equipment', 'group' => 'İqlim və su', 'label' => 'İqlim avadanlığı', 'type' => 'multiselect',
                ...
                'required' => false, 'delegatable' => true],
            ['key' => 'water_heater_type', 'group' => 'İqlim və su', 'label' => 'Su qızdırıcısı', 'type' => 'select',
                'options' => $opt(['storage' => 'Yığıcı (boyler)', 'flow' => 'Axar', 'per_riser' => 'Hər stoyaka ayrıca', 'designer' => 'Dizaynerin ixtiyarına']),
                'required' => false, 'delegatable' => true],
            ['key' => 'water_heater_volume_l', 'group' => 'İqlim və su', 'label' => 'Yığıcı su qızdırıcısının həcmi, litr', 'type' => 'number', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Məsələn: 80.',
                'skip' => ['question' => 'water_heater_type', 'operator' => 'equals', 'value' => 'storage']],
            ['key' => 'water_filtration', 'group' => 'İqlim və su', 'label' => 'Su təmizləmə / filtrasiya lazımdır?', 'type' => 'boolean', 'options' => null, 'required' => false, 'delegatable' => true],
            ['key' => 'ethernet_outlets_location', 'group' => 'Şəbəkə və təhlükəsizlik', 'label' => 'İnternet rozetkaları harada lazımdır?', 'type' => 'text', 'options' => null, 'required' => false, 'delegatable' => true,
                'help' => 'Məsələn: kabinet, qonaq otağı.'],
            ['key' => 'security_equipment', 'group' => 'Şəbəkə və təhlükəsizlik', 'label' => 'Təhlükəsizlik avadanlığı', 'type' => 'multiselect',
                'options' => $opt([
                ...
                'required' => false, 'delegatable' => true],
            ['key' => 'cctv_locations', 'group' => 'Şəbəkə və təhlükəsizlik', 'label' => 'Müşahidə kameraları harada?', 'type' => 'text', 'options' => null, 'required' => false, 'delegatable' => false,
                'help' => 'Məsələn: giriş, qaraj, sahə.',
                'skip' => ['question' => 'security_equipment', 'operator' => 'equals', 'value' => 'cctv']],
            ['key' => 'smart_home_needed', 'group' => 'Şəbəkə və təhlükəsizlik', 'label' => 'Ağıllı ev sistemi', 'type' => 'select',
                'options' => $opt(['yes' => 'Bəli', 'no' => 'Xeyr', 'designer' => 'Dizaynerin ixtiyarına']),
                'required' => false, 'delegatable' => true],
            ['key' => 'electrics_note', 'group' => 'Şəbəkə və təhlükəsizlik', 'label' => 'Elektrik üzrə xüsusi tələblər', 'type' => 'textarea', 'options' => null, 'required' => false, 'delegatable' => true,
