...
class SpecificationItemPolicy
{
    ...
    public function view(User $user, SpecificationItem $record): bool
    {
    ...
    public function update(User $user, SpecificationItem $record): bool
    {
        return $this->allowsOn($user, $record->project, AccessLevel::Edit, $record->project_id);
    }

    public function delete(User $user, SpecificationItem $record): bool
    {
        return $this->allowsOn($user, $record->project, AccessLevel::Edit, $record->project_id);
    }
}
